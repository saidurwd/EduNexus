            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false">
                <header>
                    ...
                    <div class="widget-toolbar">
                        <?php echo CHtml::link('<i class="fa fa-times"></i>', array('remove'), array('data-rel' => 'tooltip', 'title' => 'Truncate Data', 'data-placement' => 'bottom', 'class' => 'btn btn-xs btn-danger')); ?>
                    </div>
                </header>
                <!-- widget div-->
                <div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'user_id',
                                    'type' => 'raw',
                                    'value' => 'User::get_full_name($data->user_id)',
