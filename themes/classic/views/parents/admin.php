...
/* @var $model Parents */
$this->pageTitle = 'Parents - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'photo',
                                    'type' => 'raw',
                                    'value' => 'Parents::getPhoto($data->id)',
                                    'filter' => false,
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'guardian_name', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'father',
                                    'type' => 'raw',
                                    'value' => '$data->father',
                                    'filter' => CHtml::activeTextField($model, 'father', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'mother',
                                    'type' => 'raw',
                                    'value' => '$data->mother',
                                    'filter' => CHtml::activeTextField($model, 'mother', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'email',
