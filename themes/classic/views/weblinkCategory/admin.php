<?php
/* @var $this WeblinkCategoryController */
/* @var $model WeblinkCategory */
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'parent',
                                    'type' => 'raw',
                                    'value' => 'WeblinkCategory::getData($data->parent,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'parent', CHtml::listData(WeblinkCategory::model()->findAll(array('condition' => 'parent IS NULL OR parent=0', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
