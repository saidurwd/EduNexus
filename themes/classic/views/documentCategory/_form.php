    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="select">
                    <?php echo $form->dropDownList($model, 'parent', CHtml::listData(DocumentCategory::model()->findAll(array('condition' => '(parent IS NULL OR parent=0) AND (institution=0 OR institution=' . Yii::app()->user->institution . ')', 'order' => "title")), 'id', 'title'), array('empty' => 'Select a Category', 'class' => 'select2')); ?>
