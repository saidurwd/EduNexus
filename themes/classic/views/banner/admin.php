            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <?php
                        $assetsDir = dirname(__FILE__) . '/../uploads/banner/';
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'category',
                                    'type' => 'raw',
                                    'value' => 'BannerCategory::getData($data->category,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'category', CHtml::listData(BannerCategory::model()->findAll(array('condition' => 'parent IS NULL', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
                                ...
                                array(
                                    'name' => 'banner',
                                    'type' => 'html',
                                    //'value' => '$data->banner==""?Yii::app()->baseUrl."/uploads/banner/default.png" : Yii::app()->baseUrl."/uploads/banner/$data->banner"',
                                    'value' => 'CHtml::image(Yii::app()->baseUrl . "/uploads/banner/".$data->institution. "/" . $data->banner,"", array("width"=>80))',
                                    'filter' => false,
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => '$data->clickurl',
                                    'filter' => CHtml::activeTextField($model, 'clickurl', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => '$data->sticky',
                                    'filter' => CHtml::activeDropDownList($model, 'sticky', array('Yes' => 'Yes', 'No' => 'No'), array('empty' => 'All', 'class' => 'form-control')),
                                    'htmlOptions' => array('class' => 'text-center'),
                                ),
                                array(
                                    'name' => 'ordering',
