                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'category',
                                    'type' => 'raw',
                                    'value' => 'WeblinkCategory::getData($data->category,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'category', CHtml::listData(WeblinkCategory::model()->findAll(array('condition' => 'parent IS NULL OR parent=0', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'click_url', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
