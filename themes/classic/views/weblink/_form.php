    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="select">
                    <?php echo $form->dropDownList($model, 'category', CHtml::listData(WeblinkCategory::model()->findAll(array('condition' => 'parent IS NULL', 'order' => "title")), 'id', 'title'), array('empty' => 'Select a Category', 'class' => 'select2')); ?>
        ...
        <div class="row">
            <section class="col col-8">
                <label class="label"><?php echo $form->labelEx($model, 'click_url'); ?></label>
                <label class="input">
                    <?php echo $form->textField($model, 'click_url', array('maxlength' => 150, 'class' => 'col-sm-12', 'placeholder' => 'URL')); ?>
        ...
        <div class="row">       
            <section class="col col-8">
                ...
                <label for="file" class="input input-file" onchange="this.parentNode.nextSibling.value = this.value">
                    <div class="button"><?php echo $form->fileField($model, 'picture', array('class' => '', 'onchange' => 'this.parentNode.nextSibling.value = this.value')); ?>Browse</div><input type="text" placeholder="Browse file" readonly="">
