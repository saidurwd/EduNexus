...
/* @var $model SiteMenu */
$this->pageTitle = 'Site Menu - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'parent',
                                    'type' => 'raw',
                                    'value' => 'SiteMenu::getData($data->parent,"title")',
                                    'filter' => SiteMenu::get_category_new('SiteMenu', 'parent'),
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'component', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'action',
                                    'type' => 'raw',
                                    'value' => '$data->action',
                                    'filter' => CHtml::activeTextField($model, 'action', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'identity',
                                    'type' => 'raw',
                                    'value' => '$data->identity',
                                    'filter' => CHtml::activeTextField($model, 'identity', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'ordering',
                                ...
                                array(
                                    'name' => 'status',
                                    'value' => '$data->status',
                                    'filter' => CHtml::activeDropDownList($model, 'status', array('1' => 'Active', '0' => 'Inactive'), array('empty' => 'All', 'class' => 'form-control')),
