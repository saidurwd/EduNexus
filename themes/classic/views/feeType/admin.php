...
/* @var $model FeeType */
$this->pageTitle = 'Fee Type - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Fee Types' => array('admin'),
    'Manage',
);
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'monthly',
                                    'value' => '$data->monthly',
                                    'filter' => CHtml::activeDropDownList($model, 'monthly', array('Yes' => 'Yes', 'No' => 'No'), array('empty' => 'All', 'class' => 'form-control')),
