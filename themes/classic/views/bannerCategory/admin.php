<?php
/* @var $this BannerCategoryController */
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'parent',
                                    'type' => 'raw',
                                    'value' => 'BannerCategory::getData($data->parent,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'parent', CHtml::listData(BannerCategory::model()->findAll(array('condition' => 'parent IS NULL', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
