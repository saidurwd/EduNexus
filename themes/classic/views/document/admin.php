                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'category',
                                    'type' => 'raw',
                                    'value' => 'DocumentCategory::getData($data->category,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'category', CHtml::listData(DocumentCategory::model()->findAll(array('condition' => 'parent IS NULL', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'document_type', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'document_size',
                                    'type' => 'raw',
                                    'value' => 'Document::byteToMbyte($data->document_size)',
                                    'filter' => CHtml::activeTextField($model, 'document_size', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'download' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'yii::app()->createUrl("/document/download", array("id"=>$data["id"]))',
