...
<fieldset>
    <div class="row">   
        ...
        <section class="col col-2" id="divDiscountamount">
            <label class="input">
                <?php echo $form->textField($model, 'discountamount', array('maxlength' => 3, 'class' => 'col-sm-12', 'placeholder' => 'Percentage/Cash')); ?>
        ...
        <section class="col col-1">
            <?php echo CHtml::htmlButton('<i class="fa fa-plus"></i> Add', array('type' => 'submit', 'class' => 'btn btn-primary btn-sm', 'onclick' => 'newInvoice();')); ?> 
        </section>
    </div>
</fieldset>
<?php $this->endWidget(); ?>
