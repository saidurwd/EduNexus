...
/* @var $model Teacher */
$this->pageTitle = 'Teachers - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'photo',
                                    'type' => 'raw',
                                    'value' => 'Teacher::getPhoto($data->id)',
                                    'filter' => false,
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'teacher_name', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'designation',
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'designation', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'email',
