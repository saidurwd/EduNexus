            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false">
                <header>
                    ...
                    <div class="widget-toolbar">
                        <?php echo CHtml::link('<i class="fa fa-plus"></i>', array('new'), array('data-toggle' => 'modal', 'data-target' => '#newData', 'class' => 'btn btn-sm btn-primary', 'data-placement' => 'bottom', 'rel' => 'tooltip', 'data-original-title' => 'New')); ?>
                    </div>
                </header>
                <!-- widget div-->
                <div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeDropDownList($model, 'group_id', CHtml::listData(UserGroup::model()->findAll(array('condition' => 'id>=2 AND status="Active"', 'order' => 'id')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'edit' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'Yii::app()->createUrl("/user/changepwd", array("id"=>$data["id"]))',
                                            'options' => array('class' => 'btn btn-xs btn-warning fa fa-key', 'data-toggle' => 'modal', 'data-target' => '#newData'),
                                        ),
                                        'update' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'Yii::app()->createUrl("/user/improve", array("id"=>$data["id"]))',
