                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'institution',
                                    'type' => 'raw',
                                    'value' => 'Institution::getData($data->institution, "institution")',
                                    'filter' => CHtml::activeDropDownList($model, 'institution', CHtml::listData(Institution::model()->findAll(array('condition' => '', 'order' => 'institution')), 'id', 'institution'), array('empty' => 'All', 'class' => 'select2')),
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeDropDownList($model, 'group_id', CHtml::listData(UserGroup::model()->findAll(array('condition' => '', 'order' => 'id')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('style' => "text-align:left;width:100px;", 'title' => 'Group'),
                                ),
                                array(
                                    'name' => 'status',
