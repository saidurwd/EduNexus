...
<fieldset>
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php echo $form->dropDownList($model, 'institution', CHtml::listData(Institution::model()->findAll(array('condition' => '')), 'id', 'institution'), array('empty' => 'Select Institution', 'class' => 'form-control')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php echo $form->dropDownList($model, 'group_id', CHtml::listData(UserGroup::model()->findAll(array('condition' => 'status="Active"')), 'id', 'title'), array('empty' => 'Select Group', 'class' => 'form-control')); ?>
