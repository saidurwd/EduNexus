...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php echo $form->dropDownList($model, 'group_id', CHtml::listData(UserGroup::model()->findAll(array('condition' => 'id>2 AND status="Active"')), 'id', 'title'), array('empty' => 'Select Group', 'class' => 'form-control')); ?>
