    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="input">
                    <?php echo $form->textField($model, 'class', array('maxlength' => 150, 'class' => 'col-sm-12', 'placeholder' => 'Class')); ?>
        ...
        <div class="row">
            <section class="col col-6">
                <label class="label"><?php echo $form->labelEx($model, 'class_numeric'); ?></label>
                <label class="input">
                    <?php echo $form->textField($model, 'class_numeric', array('maxlength' => 11, 'class' => 'col-sm-12', 'placeholder' => 'Class Numeric')); ?>
                    <?php echo $form->error($model, 'class_numeric'); ?>
                </label>
            </section>
        </div>
        <div class="row">
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="input">
                    <?php echo $form->textField($model, 'note', array('maxlength' => 150, 'class' => 'col-sm-12', 'placeholder' => 'Note')); ?>
        ...
        <?= Institution::getAlertWarning('Note:', 'Create relevant Teacher before you add Class.') ?>
    </fieldset>
    <footer>
