...
$this->pageTitle = 'Student Leaves - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'student',
                                    'type' => 'raw',
                                    'value' => '$data->student0->name',
                                    'filter' => CHtml::activeDropDownList($model, 'student', CHtml::listData(Student::model()->findAll(array('condition' => 'institution=' . Yii::app()->user->institution, 'order' => 'name')), 'id', 'name'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'reason',
                                    'type' => 'raw',
                                    'value' => '$data->reason',
                                    'filter' => CHtml::activeTextField($model, 'reason', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'start_date',
                                    'type' => 'raw',
                                    'value' => 'User::get_date($data->start_date)',
                                    'filter' => CHtml::activeTextField($model, 'start_date', array('class' => 'form-control datepicker')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'end_date',
                                    'type' => 'raw',
                                    'value' => 'User::get_date($data->end_date)',
                                    'filter' => CHtml::activeTextField($model, 'end_date', array('class' => 'form-control datepicker')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'message',
                                    'type' => 'raw',
                                    'value' => '$data->message',
                                    'filter' => CHtml::activeTextField($model, 'message', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
                                    'value' => '$data->status',
                                    'filter' => CHtml::activeDropDownList($model, 'status', array('PENDING' => 'PENDING', 'ACCEPTED' => 'ACCEPTED', 'DECLINE' => 'DECLINE'), array('empty' => 'All', 'class' => 'form-control')),
                                    'htmlOptions' => array('class' => "text-center width-80"),
                                ),
                                array(
                                    'header' => 'Actions',
