...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php echo $form->dropDownList($model, 'group', CHtml::listData(UserGroup::model()->findAll(array('condition' => '')), 'id', 'title'), array('multiple' => true, 'class' => 'select2','style'=>'width:363px;height:100px;')); ?>
