...
/* @var $model Grade */
$this->pageTitle = 'Grades - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'grade_name', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'grade_point',
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'grade_point', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'mark_from',
                                    'type' => 'raw',
                                    'value' => '$data->mark_from',
                                    'filter' => CHtml::activeTextField($model, 'mark_from', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'mark_upto',
                                    'type' => 'raw',
                                    'value' => '$data->mark_upto',
                                    'filter' => CHtml::activeTextField($model, 'mark_upto', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'Note',
