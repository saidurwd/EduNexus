            ...
            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">        
                        ...
                        <footer>                            
                            <?php echo CHtml::link('<i class="fa fa-print"></i> PRINT', array('admitcardprint', 'class' => $class, 'exam' => $exam, 'year' => $year), array('class' => 'btn btn-success btn-sm', 'target' => '_blank')); ?>
