...
$this->pageTitle = 'Student ID Card';
            ...
            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">        
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <section class="col col-4">
                                    ...
                                    <label class="input">
                                        <?php echo Section::getSectionReport('section', @$_REQUEST['section']); ?>
                                    </label>
                                </section>
                                <section class="col col-4">
                        ...
                        <footer>                            
                            <?php echo CHtml::link('<i class="fa fa-print"></i> PRINT', array('idcardprint', 'class' => $class, 'section' => $section, 'year' => $year), array('class' => 'btn btn-success btn-sm', 'target' => '_blank')); ?>
