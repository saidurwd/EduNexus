...
$this->pageTitle = 'Grand Final Report';
$this->breadcrumbs = array(
    'Report' => array('/report/grandfinal'),
    'Grand Final Report',
);
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">        
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            'id' => 'mark-parent-grid',
                            'dataProvider' => $model->search_grandfinal(),
                            'filter' => $model,
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'view' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'yii::app()->createUrl("/report/progressreportfinalprint", array("class"=>$data["class"],"section"=>$data["section"],"group"=>$data["group"],"exam"=>$data["exam"],"year"=>$data["academic_year"]))',
                                            'options' => array('class' => 'btn btn-sm btn-primary fa fa-print', 'title' => 'Progress Report Grand Final', 'target' => '_blank'),
                                        ),
                                    ),
                                ),
                            ),
