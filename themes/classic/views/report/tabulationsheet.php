                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'template' => '{report1} {report2} {report3}',
                                    'buttons' => array(
                                        'report1' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'yii::app()->createUrl("/report/tabulationsheetprint", array("class"=>$data["class"],"section"=>$data["section"],"group"=>$data["group"],"exam"=>$data["exam"],"year"=>$data["academic_year"]))',
                                            'options' => array('class' => 'btn btn-sm btn-primary fa fa-print', 'title' => 'Tabulation Sheet V1', 'target' => '_blank'),
                                        ),
                                        'report2' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'yii::app()->createUrl("/report/tabulationsheetv2print", array("class"=>$data["class"],"section"=>$data["section"],"group"=>$data["group"],"exam"=>$data["exam"],"year"=>$data["academic_year"]))',
                                            'options' => array('class' => 'btn btn-sm btn-success fa fa-print', 'title' => 'Tabulation Sheet V2', 'target' => '_blank'),
                                        ),
                                        'report3' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'yii::app()->createUrl("/report/tabulationsheetv3print", array("class"=>$data["class"],"section"=>$data["section"],"group"=>$data["group"],"exam"=>$data["exam"],"year"=>$data["academic_year"]))',
                                            'options' => array('class' => 'btn btn-sm btn-warning fa fa-print', 'title' => 'Tabulation Sheet V3', 'target' => '_blank'),
                                        ),
                                    ),
                                ),
                            ),
