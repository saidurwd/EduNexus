...
foreach ($array as $key => $value) {
    ...
    <table class="card_holder">
        <tr>
            <td class="inst_name" colspan="3"><?= Institution::getData($value["institution"], 'institution') ?></td>
        </tr>
        <tr>
            <td class="inst_address" colspan="3"><?= Institution::getData($value["institution"], 'address') ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="student_image"><?= Student::getPhotoAdmitCardAdmin($value["id"], 100, $value["institution"]) ?> </td>
