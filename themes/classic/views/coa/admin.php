...
/* @var $model Coa */
$this->pageTitle = 'Chart of Accounts - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'parent',
                                    'type' => 'raw',
                                    'value' => 'Coa::getData($data->parent, "account_title")',
                                    'filter' => CHtml::activeDropDownList($model, 'parent', CHtml::listData(Coa::model()->findAll(array('condition' => 'parent IS NULL OR parent=0', 'order' => 'path')), 'id', 'account_title'), array('empty' => 'All', 'class' => 'select2')),
//                                    'filter' => Coa::getCOASearch($model->id),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'account_code',
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'account_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'account_title',
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'account_title', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
