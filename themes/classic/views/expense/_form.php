    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="input">
                    <?php echo Coa::getCOAForm('Expense', 'coa', $model->id); ?>
            ...
            <section class="col col-6">
                ...
                <label class="input">
                    <div class="input-group">
                        <?php echo $form->textField($model, 'expense_date', array('class' => 'col-sm-12 datepicker', 'placeholder' => 'Expense Date', 'data-dateformat' => 'yy-mm-dd')); ?>
        ...
        <?= Institution::getAlertWarning('Note:', 'Add your institute expense.') ?>
    </fieldset>
    <footer>
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Add Expense' : 'Update Expense', array('class' => 'btn btn-primary')); ?>
    </footer>
    <?php $this->endWidget(); ?>
</div><!-- form -->