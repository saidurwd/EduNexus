...
/* @var $model Section */
$this->pageTitle = 'Sections - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'shift',
                                    'type' => 'raw',
                                    'value' => 'Shift::getData($data->shift,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'shift', CHtml::listData(Classs::model()->findAll(array('condition' => 'institution=' . Yii::app()->user->institution, 'order' => '')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'section',
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => '$data->capacity',
                                    'filter' => CHtml::activeTextField($model, 'capacity', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'teacher',
