...
$this->pageTitle = 'Teachers Attendance - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Teachers Attendance' => array('admin'),
    'Manage',
);
...
$('.search-form form').submit(function(){
	$('#attendance-teacher-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'teacher',
                                    'type' => 'raw',
                                    'value' => '$data->teacher0->teacher_name',
