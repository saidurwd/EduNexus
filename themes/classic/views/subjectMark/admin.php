...
$this->pageTitle = 'Mark Distributions - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Mark Distributions' => array('admin'),
    'Manage',
);
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => '$data->written',
                                    'filter' => CHtml::activeTextField($model, 'written', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'mcq',
                                    'type' => 'raw',
                                    'value' => '$data->mcq',
                                    'filter' => CHtml::activeTextField($model, 'mcq', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'practical',
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'practical', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'class_assessment',
                                    'type' => 'raw',
                                    'value' => '$data->class_assessment',
                                    'filter' => CHtml::activeTextField($model, 'class_assessment', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'full_mark',
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'full_mark', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'with_class_assessment',
                                    'value' => '$data->with_class_assessment',
                                    'filter' => CHtml::activeDropDownList($model, 'with_class_assessment', array('Yes' => 'Yes', 'No' => 'No'), array('empty' => 'All', 'class' => 'form-control')),
                                    'htmlOptions' => array('style' => "text-align:center;"),
                                ),
                                array(
                                    'name' => 'passed_separately',
                                    'value' => '$data->passed_separately',
                                    'filter' => CHtml::activeDropDownList($model, 'passed_separately', array('Yes' => 'Yes', 'No' => 'No'), array('empty' => 'All', 'class' => 'form-control')),
                                    'htmlOptions' => array('style' => "text-align:center;"),
                                ),
                                array(
                                    'name' => 'calculate_percent',
                                    'type' => 'raw',
                                    'value' => '$data->calculate_percent',
                                    'filter' => CHtml::activeTextField($model, 'calculate_percent', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
