    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                <label class="label"><?php echo $form->labelEx($model, 'user'); ?></label>
                <label class="input">
                    <?php echo $form->dropDownList($model, 'user', CHtml::listData(User::model()->findAll(array('condition' => 'institution=' . Yii::app()->user->institution . ' AND status=1')), 'id', 'full_name'), array('empty' => 'Select Name', 'class' => 'select2')); ?>
