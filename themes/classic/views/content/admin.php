                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'featured',
                                    'value' => '$data->featured',
                                    'filter' => CHtml::activeDropDownList($model, 'featured', array('Yes' => 'Yes', 'No' => 'No'), array('empty' => 'All', 'class' => 'form-control')),
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => '$data->hits',
                                    'filter' => CHtml::activeTextField($model, 'hits', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => 'text-center', 'style' => 'width:50px;'),
                                ),
                                array(
                                    'name' => 'ordering',
                                    'type' => 'raw',
