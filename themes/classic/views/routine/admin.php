...
/* @var $model Routine */
$this->pageTitle = 'Class Routines - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Class Routines' => array('admin'),
    'Manage',
);
?>
<div class="row">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'day',
                                    'value' => '$data->day',
                                    'filter' => CHtml::activeDropDownList($model, 'day', array('SATURDAY' => 'SATURDAY', 'SUNDAY' => 'SUNDAY', 'MONDAY' => 'MONDAY', 'TUESDAY' => 'TUESDAY', 'WEDNESDAY' => 'WEDNESDAY', 'THURSDAY' => 'THURSDAY', 'FRIDAY' => 'FRIDAY'), array('empty' => 'All', 'class' => 'form-control')),
                                ...
                                array(
                                    'name' => 'starting_time',
                                    'type' => 'raw',
                                    'value' => 'User::getTime($data->starting_time)',
                                    'filter' => CHtml::activeTextField($model, 'starting_time', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'ending_time',
                                    'type' => 'raw',
                                    'value' => 'User::getTime($data->ending_time)',
                                    'filter' => CHtml::activeTextField($model, 'ending_time', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'room',
