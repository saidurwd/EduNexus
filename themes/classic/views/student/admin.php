...
/* @var $model Student */
$this->pageTitle = 'Students - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'status',
                                    'value' => '$data->status',
                                    'filter' => CHtml::activeDropDownList($model, 'status', array('ACTIVE' => 'ACTIVE', 'INACTIVE' => 'INACTIVE', 'TRANSFERRED' => 'TRANSFERRED', 'EXPIRE' => 'EXPIRE'), array('empty' => 'All', 'class' => 'form-control')),
                                    'htmlOptions' => array('class' => "text-center width-80"),
                                ),
                                array(
                                    'header' => 'Actions',
