...
$this->pageTitle = 'Assignments - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Assignments' => array('admin'),
    'Manage',
);
?>
<div class="row">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'deadline',
                                    'type' => 'raw',
                                    'value' => 'User::get_date($data->deadline)',
                                    'filter' => CHtml::activeTextField($model, 'deadline', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'created_by',
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'download' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url' => 'yii::app()->createUrl("/assignment/download", array("id"=>$data["id"]))',
