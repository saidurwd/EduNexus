...
class ExamScheduleController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['ExamSchedule'])) {
            $model->attributes = $_POST['ExamSchedule'];
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('ExamSchedule');
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['ExamSchedule']))
            $model->attributes = $_GET['ExamSchedule'];
     ...
     * @return ExamSchedule the loaded model
     ...
     * @param ExamSchedule $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'exam-schedule-form') {
