...
class SyllabusController extends Controller {
    ...
    public function actionCreate() {
        $model = new Syllabus;
        $path = Yii::app()->basePath . '/../uploads/syllabus/' . Yii::app()->user->institution;
        if (!is_dir($path)) {
        ...
        if (isset($_POST['Syllabus'])) {
            ...
            if ($model->validate()) {
                //File upload script
                if (@!empty($_FILES['Syllabus']['name']['file'])) {
                    $model->file = $_POST['Syllabus']['file'];
...
//        $model = $this->loadModel($id);
//        $myFile = Yii::app()->basePath . '/../uploads/syllabus/' . Yii::app()->user->institution . '/' . $model->file;
//        if ((is_file($myFile)) && (file_exists($myFile))) {
//            unlink($myFile);
//        }
