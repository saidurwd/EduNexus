...
class UserController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('admin', 'delete', 'create', 'update', 'view', 'edit', 'user', 'new', 'improve', 'changepwd', 'remove'),
                'users' => array('@'),
            ),
    ...
    public function actionNew() {
        ...
        if (Yii::app()->request->isAjaxRequest) {
            ...
            echo $this->renderPartial('new', array('model' => $model), true, true);
            Yii::app()->end();
        }
    ...
    public function actionImprove($id) {
        ...
        if (Yii::app()->request->isAjaxRequest) {
            ...
            echo $this->renderPartial('improve', array('model' => $model), true, true);
            Yii::app()->end();
        }
    ...
    public function actionChangepwd($id) {
        ...
        if (Yii::app()->request->isAjaxRequest) {
            ...
            echo $this->renderPartial('changepwd', array('model' => $model), true, true);
            Yii::app()->end();
        }
