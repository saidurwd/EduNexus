...
class TeacherController extends Controller {
    ...
    public function actionCreate() {
        $model = new Teacher;
        $path = Yii::app()->basePath . '/../uploads/teacher/' . Yii::app()->user->institution;
        if (!is_dir($path)) {
        ...
        if (isset($_POST['Teacher'])) {
            ...
            if ($model->validate()) {
                ...
                if (@!empty($_FILES['Teacher']['name']['photo'])) {
                    $model->photo = $_POST['Teacher']['photo'];
            ...
            if ($model->validate()) {
                ...
                if ($model->save()) {
                    if (empty($model->photo)) {
                        Teacher::model()->updateAll(array('photo' => $previuosFileName), 'id=' . (int) $model->id);
                    }
                    Yii::app()->user->setFlash('success', 'Data was saved successfully');
                    $this->redirect(array('admin'));
                }
