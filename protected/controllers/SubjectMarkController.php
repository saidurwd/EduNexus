...
class SubjectMarkController extends Controller {
    ...
    public function actionCreate() {
        $model = new SubjectMark;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['SubjectMark'])) {
            $model->attributes = $_POST['SubjectMark'];
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('SubjectMark');
    ...
    public function actionAdmin() {
        $model = new SubjectMark('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['SubjectMark']))
            $model->attributes = $_GET['SubjectMark'];
     ...
     * @return SubjectMark the loaded model
     ...
     * @param SubjectMark $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'subject-mark-form') {
