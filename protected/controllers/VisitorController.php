...
class VisitorController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('admin', 'delete', 'truncate', 'user', 'remove'),
                'users' => array('@'),
            ),
    ...
    public function actionRemove() {
        Yii::app()->db->createCommand('DELETE FROM {{visitor}} WHERE user_id IN(SELECT u.`id` FROM {{user}} u WHERE u.`institution`=' . Yii::app()->user->institution . ' )')->execute();
        Yii::app()->user->setFlash('success', 'TRUNCATE all visitors statistics data!');
