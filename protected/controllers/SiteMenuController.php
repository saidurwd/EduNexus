...
class SiteMenuController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['SiteMenu'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'Menu was created successfully');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['SiteMenu'])) {
            ...
            if ($model->save())
                Yii::app()->user->setFlash('success', 'Menu was updated successfully');
            $this->redirect(array('admin'));
        }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('SiteMenu');
    ...
    public function actionAdmin() {
        $model = new SiteMenu('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['SiteMenu']))
            $model->attributes = $_GET['SiteMenu'];
     ...
     * @param SiteMenu $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'site-menu-form') {
