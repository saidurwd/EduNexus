...
class BannerCategoryController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['BannerCategory'])) {
            ...
            if ($model->save()) {
                //add path & alias
                BannerCategory::update_path($model->id);
                BannerCategory::update_alias($model->id);
    ...
    public function actionUpdate($id) {
        $model = $this->loadModel($id);
        if ($model->deletable == 'No' || $model->institution != Yii::app()->user->institution) {
            Yii::app()->user->setFlash('error', 'This data is not editable.');
            $this->redirect(array('admin'));
        }
    ...
    public function actionDelete($id) {
        $model = $this->loadModel($id);
        if ($model->deletable == 'No' || $model->institution != Yii::app()->user->institution) {
            Yii::app()->user->setFlash('error', 'This data is not deletable.');
            $this->redirect(array('admin'));
        }
     ...
     * @param BannerCategory $model the model to be validated
     */
