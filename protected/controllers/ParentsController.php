...
class ParentsController extends Controller {
    ...
    public function actionCreate() {
        $model = new Parents;
        $path = Yii::app()->basePath . '/../uploads/parents/' . Yii::app()->user->institution;
        if (!is_dir($path)) {
        ...
        if (isset($_POST['Parents'])) {
            ...
            if ($model->validate()) {
                ...
                if (@!empty($_FILES['Parents']['name']['photo'])) {
                    $model->photo = $_POST['Parents']['photo'];
            ...
            if ($model->validate()) {
                ...
                if ($model->save()) {
                    if (empty($model->photo)) {
                        Parents::model()->updateAll(array('photo' => $previuosFileName), 'id=' . (int) $model->id);
                    }
                    Yii::app()->user->setFlash('success', 'Data was saved successfully');
                    $this->redirect(array('admin'));
                }
