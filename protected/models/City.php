...
class City extends CActiveRecord {
    ...
    public static function getData($id, $field) {
        $model = City::model()->findByAttributes(array('id' => $id));
    ...
    public static function getCity($model, $field, $id) {
        $parent1 = City::model()->findAll(array('condition' => 'status="Active"', 'order' => "title"));
