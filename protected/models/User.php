...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('institution, full_name, username, email, password', 'required'),
            array('institution, group_id, status', 'numerical', 'integerOnly' => true),
            ...
            array('id, institution, full_name, username, email, password, register_date, lastvisit, activation, group_id, status, picture', 'safe', 'on' => 'search'),
        );
    }
    ...
    public static function get_profile_picture($id) {
        ...
        if ((is_file($filePath)) && (file_exists($filePath))) {
            ...
            return CHtml::image(Yii::app()->baseUrl . '/uploads/user/thumb/default.png', 'Picture', array('alt' => 'Picture', 'class' => 'online', 'title' => '', 'style' => ''));
        }
    }
    ...
    public static function getPhoto($id) {
        ...
        $filePath = Yii::app()->basePath . '/../uploads/user/thumb/' . $value->photo;
        if ((is_file($filePath)) && (file_exists($filePath))) {
            return CHtml::image(Yii::app()->baseUrl . '/uploads/user/thumb/' . $value->photo, 'Picture', array('alt' => 'Picture', 'class' => 'img-responsive', 'title' => '', 'style' => ''));
        } else {
            return CHtml::image(Yii::app()->baseUrl . '/uploads/user/thumb/default.png', 'Picture', array('alt' => 'Picture', 'class' => 'img-responsive', 'title' => '', 'style' => ''));
        }
    }
